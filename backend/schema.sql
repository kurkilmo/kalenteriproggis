...
VALUES
    -- Sammakot
    (1, true, 'Viikkopalaveri', 'Sammakot-ryhmän viikoittainen tilannekatsaus ja seuraavien askeleiden suunnittelu.', '2025-10-21 10:00:00', '2025-10-21 11:30:00', '#1976D2'),
    (1, true, 'Projektin A-demo', 'Demo Projektin A nykyisestä tilasta ja palautteen kerääminen.', '2025-10-22 14:00:00', '2025-10-22 15:00:00', '#0288D1'),
    (1, true, 'Koulutus: Uusi API', 'Käyttöönottokoulutus uudesta Sammakot-ryhmän käyttämästä API:sta.', '2025-10-23 09:00:00', '2025-10-23 12:00:00', '#4DB6AC'),
    (1, true, 'Tiimi-ilta', 'Rentouttava tiimi-ilta keilauksen ja illallisen merkeissä.', '2025-10-24 18:00:00', '2025-10-24 21:00:00', '#F57C00'),
    (1, true, 'Sprintin suunnittelu', 'Seuraavan sprintin tehtävien läpikäynti ja priorisointi.', '2025-10-28 13:00:00', '2025-10-28 15:30:00', '#388E3C'),
    (1, true, 'Ideointisessio: Tuote B', 'Aivoriihi uuden Tuote B:n ominaisuuksista ja potentiaalisista käyttöliittymistä.', '2025-10-29 11:00:00', '2025-10-29 12:30:00', '#FFB300'),
    (1, true, 'Lounastapaaminen asiakkaan X kanssa', 'Epämuodollinen lounastapaaminen asiakkaan X kanssa projektin etenemisestä.', '2025-10-30 12:00:00', '2025-10-30 13:00:00', '#8BC34A'),
    (1, true, 'Viikon Sammakot-leffa', 'Sammakot-ryhmän sisäinen elokuvahetki toimistolla.', '2025-10-31 16:00:00', '2025-10-31 18:00:00', '#7E57C2'),
    (1, true, 'Bugien karsinta', 'Dedikoitu aika priorisoitujen bugien korjaamiseen ja testaamiseen.', '2025-11-04 09:30:00', '2025-11-04 11:00:00', '#E53935'),
